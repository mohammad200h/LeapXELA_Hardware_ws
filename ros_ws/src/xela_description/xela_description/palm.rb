...
def get_palm_constant
  <<~URDF
    <link name="leap_hand_xela_back_cover">
        <inertial>
...
def write_palm_urdf(file_path)
  File.write(file_path, render_palm_joints_urdf)
end

if __FILE__ == $0
  out_path = ENV['OUT'] || 'palm.urdf'
