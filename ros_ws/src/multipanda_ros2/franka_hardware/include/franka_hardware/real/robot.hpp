...
class Robot {
 public:
  ...
  void setModeSwitchInProgress(bool in_progress) {
    mode_switch_in_progress_ = in_progress;
  }

  bool isModeSwitchInProgress() const {
    return mode_switch_in_progress_;
  }
...
//##############################//
 ...
 private:
  ...
  std::atomic_bool mode_switch_in_progress_{false};
