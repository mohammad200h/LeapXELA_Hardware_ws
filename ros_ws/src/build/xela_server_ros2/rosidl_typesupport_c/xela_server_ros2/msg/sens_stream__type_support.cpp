...
static const _SensStream_type_support_symbol_names_t _SensStream_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xela_server_ros2, msg, SensStream)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xela_server_ros2, msg, SensStream)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xela_server_ros2, msg, SensStream)() {
  return &::xela_server_ros2::msg::rosidl_typesupport_c::SensStream_message_type_support_handle;
}
