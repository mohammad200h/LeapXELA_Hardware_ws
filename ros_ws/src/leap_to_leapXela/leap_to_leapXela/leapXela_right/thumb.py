...
class JointThFingertipRealtip:
    def joint_name(self) -> str:
        return "thfingertip_realtip"
...
def generate_thumb() -> Thumb:
    links = [LinkThP2(), LinkClipper(), LinkThP1(), LinkThFingertip(), LinkThRealtip()]
    joints = [ JointThAxl(), JointThMcp(), JointThIpl(), JointThFingertipRealtip()]
