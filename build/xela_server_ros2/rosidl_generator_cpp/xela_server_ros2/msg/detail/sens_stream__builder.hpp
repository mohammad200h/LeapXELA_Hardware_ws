...
{
public:
  explicit Init_SensStream_sensors(::xela_server_ros2::msg::SensStream & msg)
  : msg_(msg)
  {}
...
class Init_SensStream_header
{
public:
  Init_SensStream_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SensStream_sensors header(::xela_server_ros2::msg::SensStream::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_SensStream_sensors(msg_);
  }
...
{
  return xela_server_ros2::msg::builder::Init_SensStream_header();
}
