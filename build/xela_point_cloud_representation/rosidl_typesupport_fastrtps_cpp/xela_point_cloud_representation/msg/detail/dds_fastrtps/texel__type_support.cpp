...
#include "xela_point_cloud_representation/msg/detail/texel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xela_point_cloud_representation::msg::Texel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xela_point_cloud_representation::msg::Texel & ros_message)
{
  // Member: taxel_id
  cdr >> ros_message.taxel_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xela_point_cloud_representation::msg::Texel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xela_point_cloud_representation::msg::Texel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xela_point_cloud_representation::msg::Texel *>(
    untyped_ros_message);
...
{
  return &xela_point_cloud_representation::msg::typesupport_fastrtps_cpp::_Texel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xela_point_cloud_representation, msg, Texel)() {
  return &xela_point_cloud_representation::msg::typesupport_fastrtps_cpp::_Texel__handle;
}
