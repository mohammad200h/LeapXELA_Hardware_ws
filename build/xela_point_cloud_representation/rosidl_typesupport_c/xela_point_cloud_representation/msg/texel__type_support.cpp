...
static const _Texel_type_support_symbol_names_t _Texel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xela_point_cloud_representation, msg, Texel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xela_point_cloud_representation, msg, Texel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xela_point_cloud_representation, msg, Texel)() {
  return &::xela_point_cloud_representation::msg::rosidl_typesupport_c::Texel_message_type_support_handle;
}
