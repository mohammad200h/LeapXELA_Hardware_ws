...
static const _Texel_type_support_symbol_names_t _Texel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xela_point_cloud_representation, msg, Texel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xela_point_cloud_representation, msg, Texel)),
  }
};
...
{
  return &::xela_point_cloud_representation::msg::rosidl_typesupport_cpp::Texel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xela_point_cloud_representation, msg, Texel)() {
  return get_message_type_support_handle<xela_point_cloud_representation::msg::Texel>();
}
