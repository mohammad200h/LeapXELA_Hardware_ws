#!/usr/bin/env python3
"""ROS 2 subscriber: leap_joint JointState -> LeapXela hand in PyBullet.

Subscribes to ``leap_joint`` (from ``leap_publisher``) and drives
``leapXela_right/hand.urdf`` using matching URDF joint names.
"""
