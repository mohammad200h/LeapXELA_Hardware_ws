...
static rosidl_typesupport_introspection_c__MessageMember xela_server_ros2__msg__SensStream__rosidl_typesupport_introspection_c__SensStream_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(xela_server_ros2__msg__SensStream, header),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xela_server_ros2, msg, SensStream)() {
  ...
  xela_server_ros2__msg__SensStream__rosidl_typesupport_introspection_c__SensStream_message_member_array[1].members_ =
