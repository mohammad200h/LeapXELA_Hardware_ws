...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensStream_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(xela_server_ros2::msg::SensStream, header),  // bytes offset in struct
