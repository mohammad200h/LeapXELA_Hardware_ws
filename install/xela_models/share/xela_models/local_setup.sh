...
: ${AMENT_CURRENT_PREFIX:="/workspace/LeapXELA_Hardware_ws/install/xela_models"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xela_models/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xela_models/environment/path.sh"
