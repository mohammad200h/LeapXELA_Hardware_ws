...
def generate_finger(prefix: str, offset: float) -> Finger:
    ...
    realtip = LinkRealtip(prefix)

    links = [p4, p3, p2, fingertop, realtip]
    joints = [JointP4P3(prefix, offset), JointP3P2(prefix, offset), JointP2Fingertop(prefix, offset), JointFingertopRealtip(prefix, offset)]
